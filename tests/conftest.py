...
def pytest_addoption(parser):
    parser.addoption("--test_environment", action="store", default="local_repo",
                     choices=["local_repo", "jenkins_repo", "local_publish", "remote_publish"])
...
def environment(request):
    ...
    return ROOT_DIR, HOME_DIR, SJOURNAL_DIR, sjournal_exec